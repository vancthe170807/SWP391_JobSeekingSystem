                                ...
                                <div class="rts__dropdown notification__dropdown dropdown-menu top-25">
                                    <div class="rts__dropdown__content">
                                        ...
                                        <div class="notification__body">
                                            ...
                                            <div class="single__notification">
                                                <div class="notification__image">   
                                                    <img src="${pageContext.request.contextPath}/assets/img/icon/google.svg" alt="">
                                                </div>
                                            ...
                                            <div class="single__notification">
                                                <div class="notification__image">   
                                                    <img src="${pageContext.request.contextPath}/assets/img/icon/microsoft.svg" alt="">
                                                </div>
                                                <div class="notification__content">
                                                    <p>
                                        ...
                                        <div class="notification__body">
                                            ...
                                            <div class="single__notification">
                                                <div class="notification__image">   
                                                    <img src="${pageContext.request.contextPath}/assets/img/icon/linkedin.svg" alt="">
                                                </div>
                                                <div class="notification__content">
                                                    <p>
                                            ...
                                            <div class="single__notification">
                                                <div class="notification__image">   
                                                    <img src="${pageContext.request.contextPath}/assets/img/icon/udemy.svg" alt="">
                                                </div>
                                                <div class="notification__content">
                                                    <p>
                            ...
                            <div class="user__info">
                                <div class="d-flex gap-3 align-items-center pointer" data-bs-toggle="dropdown">
                                    ...
                                    <div class="user__name d-none d-xl-block">
                                        ...
                                        <h6 class="font-20 mb-0 fw-medium lh-sm">Hello ${sessionScope.account.getFirstName()} </h6>
