<%-- 
    ...
    Created on : Sep 17, 2024, 10:40:53 PM
    Author     : Admin
--%>
...
<html lang="en">
    <head>
        ...
        <!--css-->
        <jsp:include page="../common/recruiter/common-css-recruiter.jsp"></jsp:include>
        </head>
                ...
                <div class="dashboard__right">
                    <div class="dash__content">
                        ...
                        <div class="dash__overview">
                            <h6 class="fw-medium mb-30">RECRUITER HOME</h6>
...
<!--                    <a href="#" class="small__btn no__fill__btn border-6 font-xs" aria-label="Login Button" data-bs-toggle="modal" data-bs-target="#loginModal"> <i class="rt-login"></i>Sign In</a>-->
        ...
        <!-- all plugin js -->
        <jsp:include page="../common/recruiter/common-js-recruiter.jsp"></jsp:include>
    </body>
</html>
