                ...
                <div class="header__right__btn d-flex gap-3">
                    <div class="dropdown mt-auto">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end text-small shadow" aria-labelledby="dropdownUser1">
                            ...
                            <li><a class="dropdown-item text-dark" href="${pageContext.request.contextPath}/education?action=view-education"><i class="fa-solid fa-school me-2"></i> Manage your Education</a></li>
