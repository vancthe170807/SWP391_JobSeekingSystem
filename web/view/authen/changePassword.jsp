                    ...
                    <form action="#">
                        ...
                        <c:choose>
                            <c:when test="${sessionScope.role == 1}">
                                <a href="${pageContext.request.contextPath}/view/admin/adminHome.jsp" class="rts__btn fill__btn">Home Page</a>
                            </c:when>
                            <c:when test="${sessionScope.role == 2}">
                                <a href="${pageContext.request.contextPath}/view/recruiter/recruiterHome.jsp" class="rts__btn fill__btn">Home Page</a>
                            </c:when>
                            <c:when test="${sessionScope.role == 3}">
                                <a href="${pageContext.request.contextPath}/view/user/userHome.jsp" class="rts__btn fill__btn">Home Page</a>
                            </c:when>
                        </c:choose>
