            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <a href="${pageContext.request.contextPath}/view/home.jsp" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></a>
                    </div>
                    <div class="modal-body">
                        <form id="verificationForm" action="${pageContext.request.contextPath}/verifyEmployer" method="post">
                            ...
                            <a href="${pageContext.request.contextPath}/view/home.jsp" class="btn btn-primary">Home</a>
