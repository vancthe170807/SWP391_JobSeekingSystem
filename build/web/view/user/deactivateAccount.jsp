                            ...
                            <div class="change__password">
                                <div class="password__change__form">
                                    ...
                                    <div class="rts-input-group">
                                        ...
                                        <input type="password" name="currentPassword" id="currentPassword" placeholder="Enter your current password" required onkeydown="preventSpaces(event)">
                                    ...
                                    <div class="d-flex justify-content-end gap-30">
                                        <button type="button" class="rts__btn fill__btn" onclick="window.location.href = '${pageContext.request.contextPath}/view/user/userHome.jsp'">Cancel</button>
