...
<html lang="en">
    ...
    <head>
        ...
        <style>
            .sidebar {
                background-color: whitesmoke; /* Dark background for the sidebar */
                height: auto; /* Full height */
                padding: 15px; /* Adjust padding for a cleaner look */
            }

            .nav-link {
                color: white; /* White color for nav link */
            }
            ...
            .nav-link.active {
                background-color: green; /* Active link color */
                color: #fff; /* Active text color */
            }

            .tab-content {
                padding: 20px; /* Adding padding to main content */
                border: 1px solid #dee2e6; /* Add border to tab content */
                border-radius: 0.25rem; /* Rounded corners */
                background-color: white; /* Background color for tab content */
            }

            h6 {
                margin-top: 20px; /* Add margin to headings for spacing */
            }

            /* Reduce margins for forms */
            .form-label {
                margin-bottom: 0.5rem; /* Less space below labels */
            }
                    ...
                    <div class="container-fluid mt-5 mb-5">
                        <div class="row">
                            ...
                            <div class="col-md-3 sidebar p-3">
                                <h5 class="text-center text-black">User Menu</h5>
